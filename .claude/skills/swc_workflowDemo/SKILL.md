...
```json
{
  ...
  "stages": [
    { "name": "start",   "skill": "swc_workflowDemo_start",   "args": "" },
    { "name": "middle",    "skill": "swc_workflowDemo_middle",    "args": "" },
    { "name": "end",  "skill": "swc_workflowDemo_end",  "args": "" },
  ],
